...
extract($_SESSION);
$rs=mysql_query("select t.test_name,t.total_que,r.score from mst_test t, mst_result r where
...
{
echo "<tr class=style8><td>$row[0] <td align=center> 20 <td align=center> $row[2]";
}
echo "</table>";
?>
</body>
